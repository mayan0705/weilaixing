    ...
    <div>
      ...
      <div>
        <el-card class="box-card" shadow="hover">
          ...
          <div class="text item">
            <span class="spanleft">
              <span class="spanShort">隶属创新院：</span>
              <el-input class="shortInputBox" v-model="camp_id" readonly="readonly" />
            </span>
            <span class="spanright">
              <span class="spanLong">隶属班级：</span>
              <el-input class="shortInputBox" v-model="camp_class_id" readonly="readonly" />
            </span>
          </div>
          <div class="text item">
            <span class="spanleft">
    ...
    if (typeof adminName !== 'undefined' && adminName !== '') {
      axios({
        ...
        if (response.data.code === 'ok') {
          this.user_id = parseInt(sessionStorage['schoolmateIndex'])
          this.camp_id = sessionStorage['schoolmateCampIndex']
          this.camp_class_id =
            sessionStorage['schoolmateCampClassIndex']
          this.querymessage()
